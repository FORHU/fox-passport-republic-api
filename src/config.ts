...
export const ACCESS_TOKEN_EXPIRES = (process.env.ACCESS_TOKEN_EXPIRES as string) || "1d";
export const REFRESH_TOKEN_EXPIRES = (process.env.REFRESH_TOKEN_EXPIRES as string) || "7d";
...
export const VENUE4USE_ALLOW_REFERER = (process.env.VENUE4USE_ALLOW_REFFERER as string) || "localhost, venue4use.com";
