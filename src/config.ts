...
export const ACCESS_TOKEN_EXPIRES = (process.env.ACCESS_TOKEN_EXPIRES as string) || "7d";
export const REFRESH_TOKEN_EXPIRES = (process.env.ACCESS_TOKEN_EXPIRES as string) || "30d";
