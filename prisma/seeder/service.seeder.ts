  ...
  try {
    ...
    const services = [
      // ── serviceFoxer Cruz (existing) ──────────────────────────────────────
      {
        ...
        description:
          "Professional event photography and videography coverage in Metro Manila.",
        price: 15000,
        currency: "PHP",
      ...
      },
      {
        ...
        description:
          "Full-service gourmet catering with Filipino and international cuisine.",
        price: 800,
        currency: "PHP",
      ...
      },
      {
        ...
        description:
          "5-piece live band covering OPM, pop, and jazz for corporate and social events.",
        price: 25000,
        currency: "PHP",
        billingRate: BillingRate.one_time,
        status: ServiceStatus.available,
      ...
      },
      {
        ...
        description:
          "Trained and uniformed waitstaff for banquets and cocktail events.",
        price: 600,
        currency: "PHP",
        billingRate: BillingRate.daily,
        status: ServiceStatus.available,
      ...
      // ── Experience Builder: Food & Drink ──────────────────────────────────
      {
        ...
        description:
          "UV-lit cocktail bar with signature neon-themed drinks and professional bartenders.",
        price: 15000,
        currency: "PHP",
        billingRate: BillingRate.one_time,
        status: ServiceStatus.available,
      ...
      },
      {
        ...
        description:
          "Late-night ramen station with customizable bowls — the ultimate post-party fuel.",
        price: 8000,
        currency: "PHP",
        billingRate: BillingRate.one_time,
        status: ServiceStatus.available,
      ...
      },
      {
        ...
        description:
          "Premium sushi and sashimi platters crafted by a Japanese-trained chef for your event.",
        price: 12000,
        currency: "PHP",
        billingRate: BillingRate.one_time,
        status: ServiceStatus.available,
      ...
      // ── Experience Builder: Tech & AV ──────────────────────────────────────
      {
        ...
        description:
          "Club-grade Funktion-One speaker setup with professional sound engineer included.",
        price: 25000,
        currency: "PHP",
        billingRate: BillingRate.one_time,
        status: ServiceStatus.available,
      ...
      },
      {
        ...
        description:
          "30 wireless headsets with 3-channel silent disco setup for an immersive audio experience.",
        price: 18000,
        currency: "PHP",
        billingRate: BillingRate.one_time,
        status: ServiceStatus.available,
      ...
      // ── Experience Builder: Decor & Style ─────────────────────────────────
      {
        ...
        description:
          "Neon signs, holographic panels, and futuristic prop set to transform any space.",
        price: 20000,
        currency: "PHP",
        billingRate: BillingRate.one_time,
        status: ServiceStatus.available,
      ...
      },
      {
        ...
        description:
          "Modular velvet lounge furniture and low tables — perfect for VIP areas and chill zones.",
        price: 15000,
        currency: "PHP",
        billingRate: BillingRate.one_time,
        status: ServiceStatus.available,
      ...
      // ── Experience Builder: Photo & Video ─────────────────────────────────
      {
        ...
        description:
          "Analog-style photo booth with physical film prints — a timeless keepsake for guests.",
        price: 10000,
        currency: "PHP",
        billingRate: BillingRate.one_time,
        status: ServiceStatus.available,
      ...
      },
      {
        ...
        description:
          "Cinematic aerial coverage + on-the-ground camera crew for a stunning post-event film.",
        price: 22000,
        currency: "PHP",
        billingRate: BillingRate.one_time,
        status: ServiceStatus.available,
      ...
      // ── Pending (awaiting admin approval) ──────────────────────────────────
      {
        ...
        description:
          "Full event styling and design service — concept to setup.",
        price: 18000,
        currency: "PHP",
        billingRate: BillingRate.one_time,
      ...
      },
      {
        ...
        description:
          "Authentic Cebu lechon and traditional kamayan feast catering.",
        price: 1200,
        currency: "PHP",
        billingRate: BillingRate.daily,
        status: ServiceStatus.pending,
        ...
        ? [
            {
              ...
              description:
                "Acoustic vibes for sunset or electric beats for the after-party. I provide high-end audio equipment and state-of-the-art lighting to transform any space.",
              price: 28000,
              currency: "PHP",
              billingRate: BillingRate.one_time,
              status: ServiceStatus.available,
            ...
            },
            {
              ...
              description:
                "Full DMX-controlled lighting rig with moving heads, LED wash, and haze machine for concert-level atmosphere.",
              price: 20000,
              currency: "PHP",
              billingRate: BillingRate.one_time,
              status: ServiceStatus.available,
            ...
            },
            {
              ...
              description:
                "Reliable backup power for outdoor events — 50kVA silent diesel generator with full cable management.",
              price: 12000,
              currency: "PHP",
              billingRate: BillingRate.one_time,
              status: ServiceStatus.available,
        ...
        ? [
            {
              ...
              description:
                "I turn pine forests into fairy tales. Specializing in boho camping setups and intimate gatherings. My goal is to ensure your event flow is flawless and aesthetically unmatched.",
              price: 35000,
              currency: "PHP",
              billingRate: BillingRate.one_time,
              status: ServiceStatus.available,
            ...
            },
            {
              ...
              description:
                "Curated tablescapes with fresh florals, linen, and fine props tailored to your event theme.",
              price: 12000,
              currency: "PHP",
              billingRate: BillingRate.one_time,
              status: ServiceStatus.available,
            ...
            },
            {
              ...
              description:
                "Full vendor coordination and on-the-day event management so you don't have to lift a finger.",
              price: 18000,
              currency: "PHP",
              billingRate: BillingRate.one_time,
              status: ServiceStatus.available,
        ...
        ? [
            {
              ...
              description:
                "Leading treks and organizing outdoor activities. I bring the energy and expertise to keep your group safe while pushing the boundaries of adventure.",
              price: 3500,
              currency: "PHP",
              billingRate: BillingRate.daily,
              status: ServiceStatus.available,
            ...
            },
            {
              ...
              description:
                "High-energy group workshops designed to build trust, communication, and camaraderie in the wild.",
              price: 8000,
              currency: "PHP",
              billingRate: BillingRate.one_time,
              status: ServiceStatus.available,
        ...
        ? [
            {
              ...
              description:
                "Acoustic vibes for sunset or electric beats for the midnight hour. I read the room and keep the energy exactly where it needs to be — all night long.",
              price: 20000,
              currency: "PHP",
              billingRate: BillingRate.one_time,
              status: ServiceStatus.available,
            ...
            },
            {
              ...
              description:
                "4-piece band covering OPM, indie, and pop. From mellow cocktail sets to full electric performances.",
              price: 30000,
              currency: "PHP",
              billingRate: BillingRate.one_time,
              status: ServiceStatus.available,
            ...
            },
            {
              ...
              description:
                "End-to-end audio production including stage monitors, FOH mixing, and pre-event soundcheck coordination.",
              price: 15000,
              currency: "PHP",
              billingRate: BillingRate.one_time,
              status: ServiceStatus.available,
    ...
    for (let i = 1; i <= 60; i++) {
      const foxer = users.find(
        (u: any) => u.email === `ef-${String(i).padStart(2, "0")}@foxers.ph`,
      );
      if (!foxer) continue;
    ...
    const serviceImages = [
      ...
      {
        id: "seed-img-premium-catering-1",
        ...
        name: "buffet-setup.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-live-band-1",
        ...
        name: "live-band-show.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-waitstaff-1",
        serviceId: "seed-service-event-waitstaff-team",
        url: "https://images.unsplash.com/photo-1578474846511-04ba529f0b88?w=800&auto=format&fit=crop",
        name: "waitstaff.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-neon-cocktail-1",
        serviceId: "seed-service-neon-cocktail-bar",
        url: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=800&auto=format&fit=crop",
        name: "neon-drinks.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-ramen-station-1",
        serviceId: "seed-service-midnight-ramen-station",
        url: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=800&auto=format&fit=crop",
        name: "ramen-bar.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-sushi-deluxe-1",
        serviceId: "seed-service-sushi-platter-deluxe",
        url: "https://images.unsplash.com/photo-1611143669185-af224c5e3252?w=800&auto=format&fit=crop",
        name: "sushi-platter.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-funktion-sound-1",
        serviceId: "seed-service-funktion-one-sound",
        url: "https://images.unsplash.com/photo-1545128485-c400e7702796?w=800&auto=format&fit=crop",
        name: "funktion-speakers.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-silent-disco-1",
        serviceId: "seed-service-silent-disco-gear",
        url: "https://images.unsplash.com/photo-1516873240891-4bf014598ab4?w=800&auto=format&fit=crop",
        name: "silent-disco.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-cyberpunk-props-1",
        serviceId: "seed-service-cyberpunk-props",
        url: "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=800&auto=format&fit=crop",
        name: "neon-props.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-lounge-seating-1",
        serviceId: "seed-service-luxury-lounge-seating",
        url: "https://images.unsplash.com/photo-1540518614846-7eded433c457?w=800&auto=format&fit=crop",
        name: "lounge-furniture.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-film-booth-1",
        serviceId: "seed-service-film-photo-booth",
        url: "https://images.unsplash.com/photo-1533142266415-ac591a4deae9?w=800&auto=format&fit=crop",
        name: "vintage-booth.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-drone-aftermovie-1",
        serviceId: "seed-service-aftermovie-drone",
        url: "https://images.unsplash.com/photo-1508614589041-895b88991e3e?w=800&auto=format&fit=crop",
        name: "drone-aerial.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-event-styling-1",
        serviceId: "seed-service-event-styling-design",
        url: "https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&auto=format&fit=crop",
        name: "design-setup.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-cebu-lechon-1",
        serviceId: "seed-service-cebu-lechon-kamayan",
        url: "https://images.unsplash.com/photo-1544025162-d76694265947?w=800&auto=format&fit=crop",
        name: "kamayan-feast.jpg",
        type: "image/jpeg",
      },
      ...
      // Gear Foxer — sound & lighting portfolio
      {
        ...
        name: "stage-sound.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-gear-sound-2",
        serviceId: "seed-service-gear-lacoustics-sound",
        url: "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=800&auto=format&fit=crop",
        name: "concert-rig.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-gear-lighting-1",
        serviceId: "seed-service-gear-dmx-lighting",
        url: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=800&auto=format&fit=crop",
        name: "dmx-lights.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-gear-lighting-2",
        serviceId: "seed-service-gear-dmx-lighting",
      ...
      // Jasmine Reyes — event styling portfolio
      {
        ...
        name: "event-styled.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-jasmine-prod-2",
        serviceId: "seed-service-jasmine-event-production",
        url: "https://images.unsplash.com/photo-1478146896981-b80fe463b330?w=800&auto=format&fit=crop",
        name: "floral-decor.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-jasmine-table-1",
        serviceId: "seed-service-jasmine-table-styling",
        url: "https://images.unsplash.com/photo-1469371670807-013ccf25f16a?w=800&auto=format&fit=crop",
        name: "tablescape.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-jasmine-table-2",
        serviceId: "seed-service-jasmine-table-styling",
        url: "https://images.unsplash.com/photo-1561489413-985b06da5bee?w=800&auto=format&fit=crop",
        name: "reception.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-jasmine-coord-1",
        serviceId: "seed-service-jasmine-vendor-coordination",
        url: "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=800&auto=format&fit=crop",
        name: "coordination.jpg",
        type: "image/jpeg",
      },

      // Marco Santos — outdoor / team building portfolio
      {
        id: "seed-img-marco-trek-1",
      ...
      {
        id: "seed-img-marco-trek-2",
        serviceId: "seed-service-marco-live-trekking",
        url: "https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=800&auto=format&fit=crop",
        name: "outdoor-group.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-marco-team-1",
        serviceId: "seed-service-marco-team-building",
        url: "https://images.unsplash.com/photo-1522163182402-834f871fd851?w=800&auto=format&fit=crop",
        name: "team-activity.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-marco-team-2",
        serviceId: "seed-service-marco-team-building",
      ...
      // Sarah Lim — music & audio portfolio
      {
        ...
        name: "dj-performance.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-sarah-dj-2",
        serviceId: "seed-service-sarah-dj-set",
        url: "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=800&auto=format&fit=crop",
        name: "mixing-board.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-sarah-band-1",
        serviceId: "seed-service-sarah-live-band",
        url: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&auto=format&fit=crop",
        name: "live-band.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-sarah-band-2",
        serviceId: "seed-service-sarah-live-band",
      ...
      {
        id: "seed-img-sarah-sound-1",
        serviceId: "seed-service-sarah-soundcheck",
        url: "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=800&auto=format&fit=crop",
        name: "foh-mixing.jpg",
        type: "image/jpeg",
      },
      {
        id: "seed-img-sarah-sound-2",
        serviceId: "seed-service-sarah-soundcheck",
        url: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800&auto=format&fit=crop",
        name: "stage-monitors.jpg",
        type: "image/jpeg",
      },
    ];
    ...
    for (let i = 1; i <= 60; i++) {
      ...
      serviceImages.push(
        {
          id: `seed-img-ef-${i}-a`,
          serviceId: `seed-service-ef-${i}-a`,
          url: EVENT_PHOTO_URLS[(i - 1) % EVENT_PHOTO_URLS.length],
          name: `ef-${i}-portfolio-a.jpg`,
          type: "image/jpeg",
        },
        {
          id: `seed-img-ef-${i}-b`,
          serviceId: `seed-service-ef-${i}-b`,
          url: EVENT_PHOTO_URLS[i % EVENT_PHOTO_URLS.length],
          name: `ef-${i}-portfolio-b.jpg`,
          type: "image/jpeg",
        },
      );
    }
    ...
    for (let i = 1; i <= 60; i++) {
      ...
      serviceImages.push(
        {
          id: `seed-img-gf-${i}-a`,
          serviceId: `seed-service-gf-${i}-a`,
          url: GEAR_PHOTO_URLS[(i - 1) % GEAR_PHOTO_URLS.length],
          name: `gf-${i}-portfolio-a.jpg`,
          type: "image/jpeg",
        },
        {
          id: `seed-img-gf-${i}-b`,
          serviceId: `seed-service-gf-${i}-b`,
          url: GEAR_PHOTO_URLS[i % GEAR_PHOTO_URLS.length],
          name: `gf-${i}-portfolio-b.jpg`,
          type: "image/jpeg",
        },
      );
    }
    ...
    for (let i = 1; i <= 60; i++) {
      ...
      serviceImages.push(
        {
          id: `seed-img-sf-${i}-a`,
          serviceId: `seed-service-sf-${i}-a`,
          url: SERVICE_PHOTO_URLS[(i - 1) % SERVICE_PHOTO_URLS.length],
          name: `sf-${i}-portfolio-a.jpg`,
          type: "image/jpeg",
        },
        {
          id: `seed-img-sf-${i}-b`,
          serviceId: `seed-service-sf-${i}-b`,
          url: SERVICE_PHOTO_URLS[i % SERVICE_PHOTO_URLS.length],
          name: `sf-${i}-portfolio-b.jpg`,
          type: "image/jpeg",
        },
      );
    }
