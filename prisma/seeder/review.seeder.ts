...
export async function seedReviews(prisma: PrismaClient, users: any[]) {
  try {
    ...
    if (!regularUser)
      throw new Error("user@example.com not found for review seeding");
    ...
    const reviews = [
      // ── Grand Palace Hall ─────────────────────────────────────────────────
      {
        ...
        rating: 5,
        comment:
          "Grand Palace Hall is absolutely breathtaking. The lighting, the space, and the team — everything was flawless for our event.",
      },
      ...(gearFoxer
        ? [
            {
              ...
              rating: 5,
              comment:
                "One of the best venues in Manila. Excellent facilities and the staff went above and beyond.",
            },
          ]
        : []),
      ...
      // ── The Loft BGC ──────────────────────────────────────────────────────
      {
        ...
        rating: 4,
        comment:
          "The Loft BGC has a great vibe for corporate events. Modern design and the rooftop view is incredible at night.",
      },
      ...(multiRole
        ? [
            {
              ...
              rating: 5,
              comment:
                "Booked for a product launch — highly recommend. The AV setup was top-tier and the concierge was super helpful.",
            },
          ]
        : []),
      ...
      // ── Boracay Beach Resort ──────────────────────────────────────────────
      {
        ...
        rating: 5,
        comment:
          "Our beach wedding was a dream. The sunset backdrop was out of this world. Worth every peso.",
      },
      ...
      // ── Garden Gazebo ─────────────────────────────────────────────────────
      {
        ...
        rating: 5,
        comment:
          "Perfect for an intimate garden party. The lights at night made everything so magical. Will definitely come back.",
      },
    ];
    ...
    for (const r of reviews) {
      ...
      console.log(
        `✓ Seeded review: ${r.entityType} ${r.entityId} (${r.rating}★)`,
      );
    }
