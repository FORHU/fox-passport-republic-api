...
export async function seedBookings(prisma: PrismaClient, users: any[]) {
  try {
    ...
    if (!client)
      throw new Error("user@example.com not found for booking seeding");
    if (!host)
      throw new Error("host@example.com not found for booking seeding");
    ...
    const mayBookings = [
      {
        id: "seed-booking-may-birthday-01",
        eventId: "seed-event-may-birthday-01",
        userId: client.id,
        guestCount: 60,
        totalAmount: 35150,
        startAt: new Date("2026-05-07T18:00:00.000Z"),
      ...
      {
        id: "seed-booking-may-birthday-02",
        eventId: "seed-event-may-birthday-02",
        userId: host.id,
        guestCount: 40,
        totalAmount: 35150,
        startAt: new Date("2026-05-14T17:00:00.000Z"),
      ...
      {
        id: "seed-booking-may-wedding-01",
        eventId: "seed-event-may-wedding-01",
        userId: client.id,
        guestCount: 150,
        totalAmount: 85150,
        startAt: new Date("2026-05-20T10:00:00.000Z"),
      ...
      {
        id: "seed-booking-may-corporate-01",
        eventId: "seed-event-may-corporate-01",
        userId: host.id,
        guestCount: 80,
        totalAmount: 60150,
        startAt: new Date("2026-05-27T08:00:00.000Z"),
    ...
    const passportBookings = [
      ...
      {
        id: "seed-booking-host-birthday-01",
        eventId: "seed-event-birthday-01",
        userId: host.id,
        guestCount: 50,
        totalAmount: 75000,
        startAt: new Date("2026-06-10T18:00:00.000Z"),
        endAt: new Date("2026-06-10T23:00:00.000Z"),
      },
      {
        id: "seed-booking-host-social-01",
        eventId: "seed-event-social-01",
        userId: host.id,
        guestCount: 80,
        totalAmount: 40000,
        startAt: new Date("2026-07-19T16:00:00.000Z"),
        endAt: new Date("2026-07-19T23:00:00.000Z"),
      },
      {
        id: "seed-booking-host-wedding-01",
        eventId: "seed-event-may-wedding-01",
        userId: host.id,
        guestCount: 150,
        totalAmount: 85150,
      ...
      {
        id: "seed-booking-host-social2-01",
        eventId: "seed-event-may-birthday-01",
        userId: host.id,
        guestCount: 60,
        totalAmount: 35150,
      ...
      ...(jasmine
        ? [
            ...
            {
              id: "seed-booking-jasmine-02",
              eventId: "seed-event-corporate-01",
              userId: jasmine.id,
              guestCount: 30,
              totalAmount: 60000,
              startAt: new Date("2026-07-30T08:00:00.000Z"),
              endAt: new Date("2026-07-30T16:00:00.000Z"),
            },
            {
              id: "seed-booking-jasmine-03",
              eventId: "seed-event-may-birthday-01",
              userId: jasmine.id,
              guestCount: 60,
              totalAmount: 35150,
