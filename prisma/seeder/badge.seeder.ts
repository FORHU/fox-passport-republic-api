...
const badges = [
  ...
  { name: "The Architect",      description: "Designed 5 high-capacity venues",                icon: "architecture",       color: "#3b82f6", rarity: BadgeRarity.Epic,      path: UserPath.eventFoxer,   criteria: "high_capacity_venues:5" },
